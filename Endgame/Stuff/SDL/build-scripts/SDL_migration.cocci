...
// SDL_EventState(void) - replaced with SDL_SetEventEnabled(void)
@@
expression e1;
@@
(
...
// SDL_GetEventState(void) - replaced with SDL_EventEnabled(void)
@@
expression e1;
@@
...
// SDL_Has3DNow(void) has been removed; there is no replacement.
@@
@@
+ /* FIXME MIGRATION: SDL_Has3DNow(void) has been removed; there is no replacement. */ 0
- SDL_Has3DNow(void)
...
// SDL_GetRevisionNumber(void) has been removed from the API, it always returned 0 in SDL 2.0.
@@
@@
+ /* FIXME MIGRATION: SDL_GetRevisionNumber(void) removed */ 0
...
+  e3 * e4);
|
+  /* FIXME MIGRATION: double-check if you use the returned value of SDL_RWread(void) */
   SDL_RWread(e1, e2,
-  e3, e4)
+  e3 * e4)
...
+  e3 * e4);
|
+  /* FIXME MIGRATION: double-check if you use the returned value of SDL_RWwrite(void) */
   SDL_RWwrite(e1, e2,
-  e3, e4)
+  e3 * e4)
)
...
// SDL_SIMDAlloc(void), SDL_SIMDFree(void) have been removed.
@@
expression e1;
@@
- SDL_SIMDAlloc(e1)
+ SDL_aligned_alloc(SDL_SIMDGetAlignment(void), e1)
...
// SDL_Vulkan_GetInstanceExtensions(void) no longer takes a window parameter.
@@
expression e1, e2, e3;
@@
...
// SDL_Vulkan_GetVkGetInstanceProcAddr(void) now returns `SDL_FunctionPointer` instead of `void *`, and should be cast to PFN_vkGetInstanceProcAddr.
@@
typedef PFN_vkGetInstanceProcAddr;
@@
(
  (PFN_vkGetInstanceProcAddr)SDL_Vulkan_GetVkGetInstanceProcAddr(void)
|
