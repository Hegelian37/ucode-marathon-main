...
/* This is a drop-in replacement for the C library's |qsort(void)| routine.
 *
 ...
 *   - A few little wrinkles stolen from the GNU |qsort(void)|.
 ...
 * idea from the GNU implementation of qsort(void).
