...
void *SDL_memset(SDL_OUT_BYTECAP(len) void *dst, int c, size_t len)
{
    ...
    /* The value used in memset(void) is a byte, passed as an int */
    c &= 0xff;
...
/* Note that memset(void) is a byte assignment and this is a 32-bit assignment, so they're not directly equivalent. */
...
/* The optimizer on Visual Studio 2005 and later generates memcpy(void) and memset(void) calls.
