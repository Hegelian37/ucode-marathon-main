...
static VkResult VULKAN_AllocateBuffer(VULKAN_RenderData *rendererData, VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags memoryProps, VULKAN_Buffer *bufferOut)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateBuffer(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        ...
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetBufferMemoryRequirements(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyBuffer(rendererData, bufferOut);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkAllocateMemory(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    result = vkBindBufferMemory(rendererData->device, bufferOut->buffer, bufferOut->deviceMemory, 0);
    if (result != VK_SUCCESS) {
        VULKAN_DestroyBuffer(rendererData, bufferOut);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkBindBufferMemory(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyBuffer(rendererData, bufferOut);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkMapMemory(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    bufferOut->size = size;
    return result;
...
static VkResult VULKAN_AllocateImage(VULKAN_RenderData *rendererData, uint32_t width, uint32_t height, VkFormat format, VkImageUsageFlags imageUsage, VkComponentMapping swizzle, VkImage externalImage, VULKAN_Image *imageOut)
{
    ...
    if (externalImage == VK_NULL_HANDLE) {
        ...
        if (result != VK_SUCCESS) {
            ...
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateImage(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyImage(rendererData, imageOut);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetImageMemoryRequirements(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyImage(rendererData, imageOut);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkBindImageMemory(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyImage(rendererData, imageOut);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateImageView(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
...
static VkResult VULKAN_AcquireNextSwapchainImage(SDL_Renderer *renderer)
{
    ...
    if (result == VK_ERROR_OUT_OF_DATE_KHR || result == VK_ERROR_SURFACE_LOST_KHR) {
        ...
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkAcquireNextImageKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    VULKAN_Shader shader, SDL_BlendMode blendMode, VkPrimitiveTopology topology, VkFormat format)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateGraphicsPipelines(void): %s\n", SDL_Vulkan_GetResultString(result));
        return NULL;
    }
...
static VkResult VULKAN_CreateVertexBuffer(VULKAN_RenderData *rendererData, size_t vbidx, size_t size)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "VULKAN_AllocateBuffer(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    return result;
}
...
static VkResult VULKAN_FindPhysicalDevice(VULKAN_RenderData *rendererData)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkEnumeratePhysicalDevices(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    if (physicalDeviceCount == 0) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkEnumeratePhysicalDevices(void): no physical devices\n");
        return VK_ERROR_UNKNOWN;
    }
    ...
    for (physicalDeviceIndex = 0; physicalDeviceIndex < physicalDeviceCount; physicalDeviceIndex++) {
        ...
        for (queueFamilyIndex = 0; queueFamilyIndex < queueFamiliesCount; queueFamilyIndex++) {
            ...
            if (result != VK_SUCCESS) {
                ...
                SDL_free(queueFamiliesProperties);
                SDL_free(deviceExtensions);
                SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetPhysicalDeviceSurfaceSupportKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
                return VK_ERROR_UNKNOWN;
            }
            if (supported) {
        ...
        if (result != VK_SUCCESS) {
            ...
            SDL_free(queueFamiliesProperties);
            SDL_free(deviceExtensions);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkEnumerateDeviceExtensionProperties(void): %s\n", SDL_Vulkan_GetResultString(result));
            return VK_ERROR_UNKNOWN;
        }
...
static VkResult VULKAN_GetSurfaceFormats(VULKAN_RenderData *rendererData)
{
    ...
    if (result != VK_SUCCESS) {
        ...
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetPhysicalDeviceSurfaceFormatsKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
...
static VkSemaphore VULKAN_CreateSemaphore(VULKAN_RenderData *rendererData)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateSemaphore(void): %s\n", SDL_Vulkan_GetResultString(result));
...
{
    VULKAN_RenderData *rendererData = (VULKAN_RenderData *)renderer->driverdata;
    SDL_VideoDevice *device = SDL_GetVideoDevice(void);
    VkResult result = VK_SUCCESS;
    ...
    if (createDebug && VULKAN_ValidationLayersFound(void)) {
        const char *validationLayerName[] = { "VK_LAYER_KHRONOS_validation" };
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateInstance(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (!device->Vulkan_CreateSurface || !device->Vulkan_CreateSurface(device, renderer->window, rendererData->instance, NULL, &rendererData->surface)) {
        VULKAN_DestroyAll(renderer);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "Vulkan_CreateSurface(void) failed.\n");
        return VK_ERROR_UNKNOWN;
    }
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateDevice(void): %s\n", SDL_Vulkan_GetResultString(result));
        VULKAN_DestroyAll(renderer);
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyAll(renderer);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateCommandPool(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    for (uint32_t i = 0; i < NUM_SHADERS; i++) {
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateShaderModule(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateDescriptorSetLayout(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreatePipelineLayout(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    }
    ...
    /* Create samplers */
    {
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateSampler(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    ...
    VkFormat format, int imageViewCount, VkImageView *imageViews, VkFramebuffer *framebuffers, VkRenderPass renderPasses[SDL_VULKAN_NUM_RENDERPASSES])
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateRenderPass(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    for (int i = 0; i < imageViewCount; i++) {
        ...
        if (result != VK_SUCCESS) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateFramebuffer(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    }
...
static VkResult VULKAN_CreateSwapChain(SDL_Renderer *renderer, int w, int h)
{
    ...
    if (result != VK_SUCCESS) {
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (!(renderer->info.flags & SDL_RENDERER_PRESENTVSYNC)) {
        ...
        if (result != VK_SUCCESS) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetPhysicalDeviceSurfacePresentModesKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    ...
    if (result != VK_SUCCESS) {
        rendererData->swapchain = VK_NULL_HANDLE;
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateSwapchainKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        ...
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkGetSwapchainImagesKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyAll(renderer);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkAllocateCommandBuffers(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    for (uint32_t i = 0; i < rendererData->swapchainImageCount; i++) {
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateFence(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    }
    ...
    if (result != VK_SUCCESS) {
        VULKAN_DestroyAll(renderer);
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "VULKAN_CreateFramebuffersAndRenderPasses(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
    ...
    for (uint32_t i = 0; i < rendererData->swapchainImageCount; i++) {
        ...
        if (result != VK_SUCCESS) {
            VULKAN_DestroyAll(renderer);
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkCreateDescriptorPool(void): %s\n", SDL_Vulkan_GetResultString(result));
            return result;
        }
    }
...
static int VULKAN_CreateTexture(SDL_Renderer *renderer, SDL_Texture *texture, SDL_PropertiesID create_props)
{
    ...
    if (result != VK_SUCCESS) {
        ...
        SDL_LogError(SDL_LOG_CATEGORY_RENDER, "VULKAN_AllocateImage(void): %s\n", SDL_Vulkan_GetResultString(result));
        return result;
    }
...
static int VULKAN_UpdateViewport(SDL_Renderer *renderer)
{
    ...
    projection = MatrixIdentity(void);
...
static int VULKAN_RenderPresent(SDL_Renderer *renderer)
{
    ...
    if (rendererData->currentCommandBuffer) {
        ...
        if (result != VK_SUCCESS) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkResetFences(void): %s\n", SDL_Vulkan_GetResultString(result));
            return -1;
        }
        ...
        if (result != VK_SUCCESS) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkQueueSubmit(void): %s\n", SDL_Vulkan_GetResultString(result));
            return -1;
        }
        rendererData->currentCommandBuffer = VK_NULL_HANDLE;
        ...
        if ((result != VK_SUCCESS) && (result != VK_ERROR_OUT_OF_DATE_KHR) && (result != VK_ERROR_SURFACE_LOST_KHR) && (result != VK_SUBOPTIMAL_KHR )) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkQueuePresentKHR(void): %s\n", SDL_Vulkan_GetResultString(result));
            return -1;
        }
        ...
        if (result != VK_SUCCESS) {
            SDL_LogError(SDL_LOG_CATEGORY_RENDER, "vkWaitForFences(void): %s\n", SDL_Vulkan_GetResultString(result));
            return -1;
        }
    }
...
SDL_Renderer *VULKAN_CreateRenderer(SDL_Window *window, SDL_PropertiesID create_props)
{
    ...
    rendererData->identity = MatrixIdentity(void);
