...
// These pointers get set during SDL_ChooseAudioConverters(void) to various SIMD implementations.
...
/* Backends should call this as devices are added to the system (such as
   ...
   for every device found during DetectDevices(void). */
...
typedef struct SDL_AudioDriverImpl
{
    ...
    void (*FreeDeviceHandle)(SDL_AudioDevice *device); // SDL is done with this device; free the handle from SDL_AddAudioDevice(void)
