    ...
    MAIN_THREAD_EM_ASM({
        ...
        if ($0) {
            ...
            if (SDL3.capture.stream !== undefined) {
                var tracks = SDL3.capture.stream.getAudioTracks(void);
            ...
            if (SDL3.capture.scriptProcessorNode !== undefined) {
                ...
                SDL3.capture.scriptProcessorNode.disconnect(void);
            }
            if (SDL3.capture.mediaStreamNode !== undefined) {
                SDL3.capture.mediaStreamNode.disconnect(void);
            }
            SDL3.capture = undefined;
        } else {
            if (SDL3.audio.scriptProcessorNode != undefined) {
                SDL3.audio.scriptProcessorNode.disconnect(void);
            }
...
static int EMSCRIPTENAUDIO_OpenDevice(SDL_AudioDevice *device)
{
    ...
    const int result = MAIN_THREAD_EM_ASM_INT({
        ...
        if (!SDL3.audioContext) {
            if (typeof(AudioContext) !== 'undefined') {
                SDL3.audioContext = new AudioContext(void);
            } else if (typeof(webkitAudioContext) !== 'undefined') {
                SDL3.audioContext = new webkitAudioContext(void);
            }
            if (SDL3.audioContext) {
    ...
    if (device->iscapture) {
        ...
        MAIN_THREAD_EM_ASM({
            ...
            var silence_callback = function(void) {
