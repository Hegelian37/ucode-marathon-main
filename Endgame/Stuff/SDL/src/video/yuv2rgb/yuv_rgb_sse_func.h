...
\
	...
	RGB1 = _mm_and_si128(_mm_unpacklo_epi8(_mm_setzero_si128(void), R1), red_mask); \
	RGB2 = _mm_and_si128(_mm_unpackhi_epi8(_mm_setzero_si128(void), R1), red_mask); \
	RGB3 = _mm_and_si128(_mm_unpacklo_epi8(_mm_setzero_si128(void), R2), red_mask); \
	RGB4 = _mm_and_si128(_mm_unpackhi_epi8(_mm_setzero_si128(void), R2), red_mask); \
	tmp1 = _mm_slli_epi16(_mm_srli_epi16(_mm_unpacklo_epi8(G1, _mm_setzero_si128(void)), 2), 5); \
	tmp2 = _mm_slli_epi16(_mm_srli_epi16(_mm_unpackhi_epi8(G1, _mm_setzero_si128(void)), 2), 5); \
	tmp3 = _mm_slli_epi16(_mm_srli_epi16(_mm_unpacklo_epi8(G2, _mm_setzero_si128(void)), 2), 5); \
	tmp4 = _mm_slli_epi16(_mm_srli_epi16(_mm_unpackhi_epi8(G2, _mm_setzero_si128(void)), 2), 5); \
	RGB1 = _mm_or_si128(RGB1, tmp1); \
	RGB2 = _mm_or_si128(RGB2, tmp2); \
	RGB3 = _mm_or_si128(RGB3, tmp3); \
	RGB4 = _mm_or_si128(RGB4, tmp4); \
	tmp1 = _mm_srli_epi16(_mm_unpacklo_epi8(B1, _mm_setzero_si128(void)), 3); \
	tmp2 = _mm_srli_epi16(_mm_unpackhi_epi8(B1, _mm_setzero_si128(void)), 3); \
	tmp3 = _mm_srli_epi16(_mm_unpacklo_epi8(B2, _mm_setzero_si128(void)), 3); \
	tmp4 = _mm_srli_epi16(_mm_unpackhi_epi8(B2, _mm_setzero_si128(void)), 3); \
	RGB1 = _mm_or_si128(RGB1, tmp1); \
	RGB2 = _mm_or_si128(RGB2, tmp2); \
	RGB3 = _mm_or_si128(RGB3, tmp3); \
	RGB4 = _mm_or_si128(RGB4, tmp4); \
...
#define YUV2RGB_32 \
	...
	u_16 = _mm_unpacklo_epi8(u, _mm_setzero_si128(void)); \
	v_16 = _mm_unpacklo_epi8(v, _mm_setzero_si128(void)); \
	...
	\
	READ_Y(y_ptr1) \
	y_16_1 = _mm_unpacklo_epi8(y, _mm_setzero_si128(void)); \
	y_16_2 = _mm_unpackhi_epi8(y, _mm_setzero_si128(void)); \
	\
	...
	u_16 = _mm_unpackhi_epi8(u, _mm_setzero_si128(void)); \
	v_16 = _mm_unpackhi_epi8(v, _mm_setzero_si128(void)); \
	u_16 = _mm_add_epi16(u_16, _mm_set1_epi16(-128)); \
	v_16 = _mm_add_epi16(v_16, _mm_set1_epi16(-128)); \
	\
	UV2RGB_16(u_16, v_16, r_16_1, g_16_1, b_16_1, r_16_2, g_16_2, b_16_2) \
