...
struct SDL_VideoData
{
    ...
    */
    ...
    /* A WinRT DisplayRequest, used for implementing SDL_*ScreenSaver(void) functions.
...
#define WINRT_DISPLAY_PROPERTY(NAME) (Windows::Graphics::Display::DisplayInformation::GetForCurrentView(void)->NAME)
#else
