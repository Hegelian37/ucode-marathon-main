...
int HandleWsEvent(SDL_VideoDevice *_this, const TWsEvent &aWsEvent)
{
    ...
    switch (aWsEvent.Type(void)) {
    case EEventKeyDown: /* Key events */
        SDL_SendKeyboardKey(0, SDL_PRESSED, ConvertScancode(_this, aWsEvent.Key(void)->iScanCode));
        break;
    case EEventKeyUp: /* Key events */
        SDL_SendKeyboardKey(0, SDL_RELEASED, ConvertScancode(_this, aWsEvent.Key(void)->iScanCode));
        break;
    ...
    case EEventFocusLost: /* SDL window lost focus */
    {
        ...
        w.SetExtent(TPoint(0, 0), phdata->NGAGE_WsWindow.Size(void));
