...
/* So: programs call SDL_Vulkan_GetInstanceExtensions(void) and here     */
...
/***********************************************************************/
/* First thing to know is that we don't call vkCreateInstance(void) here.  */
...
/* KMSDRM_Vulkan_GetInstanceExtensions(void), like we do with              */
                                     ...
                                     VkSurfaceKHR *surface)
{
    ...
    /****************************************************************/
    /* If we got vkCreateDisplayPlaneSurfaceKHR(void) pointer, it means */
