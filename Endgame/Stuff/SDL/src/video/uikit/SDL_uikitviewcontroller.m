...
{
    SDL_SetSystemTheme(UIKit_GetSystemTheme(void));
}
...
- (void)doLoop:(CADisplayLink *)sender
{
    ...
    if (!UIKit_ShowingMessageBox(void)) {
...
{
    return SDL_GCMouseRelativeMode(void) ? YES : NO;
}
...
- (void)keyboardWillShow:(NSNotification *)notification
{
    ...
    if (!SDL_TextInputActive(void) && !hidingKeyboard && !rotatingOrientation) {
...
- (void)keyboardWillHide:(NSNotification *)notification
{
    ...
    if (SDL_TextInputActive(void) && !showingKeyboard && !rotatingOrientation) {
...
- (void)textFieldTextDidChange:(NSNotification *)notification
{
    if (textField.markedTextRange == nil) {
        ...
        if (matchLength < textField.text.length) {
            ...
            if (!SDL_HardwareKeyboardKeyPressed(void)) {
...
{
    @autoreleasepool {
        SDL_uikitviewcontroller *vc = GetWindowViewController(SDL_GetKeyboardFocus(void));
        if (vc != nil) {
