...
{
    @autoreleasepool {
        SDLEAGLContext *context = (__bridge SDLEAGLContext *)SDL_GL_GetCurrentContext(void);
...
SDL_GLContext UIKit_GL_CreateContext(SDL_VideoDevice *_this, SDL_Window *window)
{
    @autoreleasepool {
        ...
        if (_this->gl_config.share_with_current_context) {
            EAGLContext *currContext = (__bridge EAGLContext *)SDL_GL_GetCurrentContext(void);
...
void UIKit_GL_RestoreCurrentContext(void)
{
    @autoreleasepool {
         ...
         */
        EAGLContext *context = (__bridge EAGLContext *)SDL_GL_GetCurrentContext(void);
