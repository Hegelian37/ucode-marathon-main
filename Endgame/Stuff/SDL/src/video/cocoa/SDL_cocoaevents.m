...
- (void)focusSomeWindow:(NSNotification *)aNotification
{
    ...
    device = SDL_GetVideoDevice(void);
    if (device && device->windows) {
...
{
    Cocoa_UpdateDisplays(SDL_GetVideoDevice(void));
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(id)object
                       ...
                       context:(void *)context
{
    SDL_SetSystemTheme(Cocoa_GetSystemTheme(void));
}
...
static void CreateApplicationMenus(void)
{
    ...
    appName = GetApplicationName(void);
    ...
    @autoreleasepool {
        ...
        if (NSApp == nil) {
            ...
            if ([NSApp mainMenu] == nil) {
                ...
                nibLoaded = LoadMainMenuNibIfAvailable(void);
                if (!nibLoaded) {
...
int Cocoa_SuspendScreenSaver(SDL_VideoDevice *_this)
{
    @autoreleasepool {
        ...
        if (_this->suspend_screensaver) {
            ...
            NSString *name = [GetApplicationName(void) stringByAppendingString:@" using SDL_DisableScreenSaver"];
