...
SDL_X11_SYM(XSizeHints*,XAllocSizeHints,(void),(void),return)
SDL_X11_SYM(XWMHints*,XAllocWMHints,(void),(void),return)
SDL_X11_SYM(XClassHint*,XAllocClassHint,(void),(void),return)
...
SDL_X11_SYM(Status,XInitThreads,(void),(void),return)
