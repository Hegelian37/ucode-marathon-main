...
Uint64 SDLTest_RandomUint64(void)
{
    ...
    value.v32[0] = SDLTest_RandomSint32(void);
    value.v32[1] = SDLTest_RandomSint32(void);
...
Sint32 SDLTest_RandomIntegerInRange(Sint32 pMin, Sint32 pMax)
{
    ...
    number = SDLTest_RandomUint32(void);
...
static Uint64 SDLTest_GenerateUnsignedBoundaryValues(const Uint64 maxValue, Uint64 boundary1, Uint64 boundary2, SDL_bool validDomain)
{
    ...
    return tempBuf[SDLTest_RandomUint8(void) % index];
}
...
{
    return SDLTest_RandomUint32(void) / (float)UINT_MAX;
}

float SDLTest_RandomFloat(void)
{
    return (float)(SDLTest_RandomUnitDouble(void) * 2.0 * (double)FLT_MAX - (double)(FLT_MAX));
}

double
SDLTest_RandomUnitDouble(void)
{
    return (double)(SDLTest_RandomUint64(void) >> 11) * (1.0 / 9007199254740992.0);
}
...
char *SDLTest_RandomAsciiStringWithMaximumLength(int maxLength)
{
    ...
    size = (SDLTest_RandomUint32(void) % (maxLength + 1));
    if (size == 0) {
        size = 1;
    }
