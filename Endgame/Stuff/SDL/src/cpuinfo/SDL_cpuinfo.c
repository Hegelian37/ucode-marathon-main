...
#elif defined(SDL_PLATFORM_LINUX)
    return readProcAuxvForNeon(void);
#elif defined(SDL_PLATFORM_ANDROID)
    /* Use NDK cpufeatures to read either /proc/self/auxv or /proc/cpuinfo */
    {
        AndroidCpuFamily cpu_family = android_getCpuFamily(void);
        if (cpu_family == ANDROID_CPU_FAMILY_ARM) {
            uint64_t cpu_features = android_getCpuFeatures(void);
...
#define CPU_haveLSX(void)  (CPU_readCPUCFG(void) & CPU_CFG2_LSX)
#define CPU_haveLASX(void) (CPU_readCPUCFG(void) & CPU_CFG2_LASX)

#ifdef __e2k__
#ifdef __MMX__
#define CPU_haveMMX(void) (1)
#else
#define CPU_haveMMX(void) (0)
#endif
#ifdef __SSE__
#define CPU_haveSSE(void) (1)
#else
#define CPU_haveSSE(void) (0)
#endif
#ifdef __SSE2__
#define CPU_haveSSE2(void) (1)
#else
#define CPU_haveSSE2(void) (0)
#endif
#ifdef __SSE3__
#define CPU_haveSSE3(void) (1)
#else
#define CPU_haveSSE3(void) (0)
#endif
#ifdef __SSE4_1__
#define CPU_haveSSE41(void) (1)
#else
#define CPU_haveSSE41(void) (0)
#endif
#ifdef __SSE4_2__
#define CPU_haveSSE42(void) (1)
#else
#define CPU_haveSSE42(void) (0)
#endif
#ifdef __AVX__
#define CPU_haveAVX(void) (1)
#else
#define CPU_haveAVX(void) (0)
#endif
#else
#define CPU_haveMMX(void)   (CPU_CPUIDFeatures[3] & 0x00800000)
#define CPU_haveSSE(void)   (CPU_CPUIDFeatures[3] & 0x02000000)
#define CPU_haveSSE2(void)  (CPU_CPUIDFeatures[3] & 0x04000000)
#define CPU_haveSSE3(void)  (CPU_CPUIDFeatures[2] & 0x00000001)
#define CPU_haveSSE41(void) (CPU_CPUIDFeatures[2] & 0x00080000)
#define CPU_haveSSE42(void) (CPU_CPUIDFeatures[2] & 0x00100000)
#define CPU_haveAVX(void)   (CPU_OSSavesYMM && (CPU_CPUIDFeatures[2] & 0x10000000))
#endif
...
SDL_GetCPUName(void)
{
    ...
    SDL_strlcpy(SDL_CPUName, __builtin_cpu_name(void), sizeof(SDL_CPUName));
...
{
    const char *cpuType = SDL_GetCPUType(void);
    int a, b, c, d;
    (void)a;
    (void)b;
    (void)c;
...
static Uint32 SDL_GetCPUFeatures(void)
{
    if (SDL_CPUFeatures == 0xFFFFFFFF) {
        ...
        if (CPU_haveSSE2(void)) {
            SDL_CPUFeatures |= CPU_HAS_SSE2;
            SDL_SIMDAlignment = SDL_max(SDL_SIMDAlignment, 16);
        }
        if (CPU_haveSSE3(void)) {
            SDL_CPUFeatures |= CPU_HAS_SSE3;
            SDL_SIMDAlignment = SDL_max(SDL_SIMDAlignment, 16);
        }
        if (CPU_haveSSE41(void)) {
            SDL_CPUFeatures |= CPU_HAS_SSE41;
            SDL_SIMDAlignment = SDL_max(SDL_SIMDAlignment, 16);
        }
        if (CPU_haveSSE42(void)) {
...
#define CPU_FEATURE_AVAILABLE(f) ((SDL_GetCPUFeatures(void) & (f)) ? SDL_TRUE : SDL_FALSE)
...
int SDL_GetSystemRAM(void)
{
    if (!SDL_SystemRAM) {
        ...
        if (SDL_SystemRAM <= 0) {
            ...
            SDL_SystemRAM = GetMemorySize(void);
        }
#endif
#ifdef SDL_PLATFORM_HAIKU
        if (SDL_SystemRAM <= 0) {
...
size_t SDL_SIMDGetAlignment(void)
{
    if (SDL_SIMDAlignment == 0xFFFFFFFF) {
        SDL_GetCPUFeatures(void); /* make sure this has been calculated */
    }
