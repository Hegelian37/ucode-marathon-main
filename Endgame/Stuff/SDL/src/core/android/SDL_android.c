...
static JNINativeMethod SDLActivity_tab[] = {
    { "nativeGetVersion", "(void)Ljava/lang/String;", SDL_JAVA_INTERFACE(nativeGetVersion) },
    { "nativeSetupJNI", "(void)I", SDL_JAVA_INTERFACE(nativeSetupJNI) },
    ...
    { "onNativeResize", "(void)V", SDL_JAVA_INTERFACE(onNativeResize) },
    { "onNativeSurfaceCreated", "(void)V", SDL_JAVA_INTERFACE(onNativeSurfaceCreated) },
    { "onNativeSurfaceChanged", "(void)V", SDL_JAVA_INTERFACE(onNativeSurfaceChanged) },
    { "onNativeSurfaceDestroyed", "(void)V", SDL_JAVA_INTERFACE(onNativeSurfaceDestroyed) },
    { "onNativeKeyDown", "(I)V", SDL_JAVA_INTERFACE(onNativeKeyDown) },
    { "onNativeKeyUp", "(I)V", SDL_JAVA_INTERFACE(onNativeKeyUp) },
    { "onNativeSoftReturnKey", "(void)Z", SDL_JAVA_INTERFACE(onNativeSoftReturnKey) },
    { "onNativeKeyboardFocusLost", "(void)V", SDL_JAVA_INTERFACE(onNativeKeyboardFocusLost) },
    { "onNativeTouch", "(IIIFFF)V", SDL_JAVA_INTERFACE(onNativeTouch) },
    { "onNativeMouse", "(IIFFZ)V", SDL_JAVA_INTERFACE(onNativeMouse) },
    { "onNativeAccel", "(FFF)V", SDL_JAVA_INTERFACE(onNativeAccel) },
    { "onNativeClipboardChanged", "(void)V", SDL_JAVA_INTERFACE(onNativeClipboardChanged) },
    { "nativeLowMemory", "(void)V", SDL_JAVA_INTERFACE(nativeLowMemory) },
    { "onNativeLocaleChanged", "(void)V", SDL_JAVA_INTERFACE(onNativeLocaleChanged) },
    { "onNativeDarkModeChanged", "(Z)V", SDL_JAVA_INTERFACE(onNativeDarkModeChanged) },
    { "nativeSendQuit", "(void)V", SDL_JAVA_INTERFACE(nativeSendQuit) },
    { "nativeQuit", "(void)V", SDL_JAVA_INTERFACE(nativeQuit) },
    { "nativePause", "(void)V", SDL_JAVA_INTERFACE(nativePause) },
    { "nativeResume", "(void)V", SDL_JAVA_INTERFACE(nativeResume) },
    ...
    { "nativeAllowRecreateActivity", "(void)Z", SDL_JAVA_INTERFACE(nativeAllowRecreateActivity) },
    { "nativeCheckSDLThreadCounter", "(void)I", SDL_JAVA_INTERFACE(nativeCheckSDLThreadCounter) }
};
...
static JNINativeMethod SDLAudioManager_tab[] = {
    { "nativeSetupJNI", "(void)I", SDL_JAVA_AUDIO_INTERFACE(nativeSetupJNI) },
...
static JNINativeMethod SDLControllerManager_tab[] = {
    { "nativeSetupJNI", "(void)I", SDL_JAVA_CONTROLLER_INTERFACE(nativeSetupJNI) },
...
static int Android_JNI_SetEnv(JNIEnv *env)
{
    ...
    if (status < 0) {
        __android_log_print(ANDROID_LOG_ERROR, "SDL", "Failed pthread_setspecific(void) in Android_JNI_SetEnv(void) (err=%d)", status);
    }
    return status;
}
...
JNIEnv *Android_JNI_GetEnv(void)
{
    ...
    if (!env) {
        /* If it fails, try to attach ! (e.g the thread isn't created with SDL_CreateThread(void) */
        int status;
...
/* Set up an external thread for using JNI with Android_JNI_GetEnv(void) */
...
static void Android_JNI_CreateKey(void)
{
    ...
    if (status < 0) {
        __android_log_print(ANDROID_LOG_ERROR, "SDL", "Error initializing mThreadKey with pthread_key_create(void) (err=%d)", status);
    }
}
...
static void Android_JNI_CreateKey_once(void)
{
    ...
    if (status < 0) {
        __android_log_print(ANDROID_LOG_ERROR, "SDL", "Error initializing mThreadKey with pthread_once(void) (err=%d)", status);
    }
}
...
/* Get SDL version -- called before SDL_main(void) to verify JNI bindings */
...
/* Activity initialization -- called before SDL_main(void) to initialize JNI bindings */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativeSetupJNI)(JNIEnv *env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeSetupJNI(void)");
    ...
    if (!Android_ActivityMutex) {
        Android_ActivityMutex = SDL_CreateMutex(void); /* Could this be created twice if onCreate(void) is called a second time ? */
    }
    ...
    midClipboardGetText = (*env)->GetStaticMethodID(env, mActivityClass, "clipboardGetText", "(void)Ljava/lang/String;");
    midClipboardHasText = (*env)->GetStaticMethodID(env, mActivityClass, "clipboardHasText", "(void)Z");
    ...
    midGetContext = (*env)->GetStaticMethodID(env, mActivityClass, "getContext", "(void)Landroid/content/Context;");
    midGetManifestEnvironmentVariables = (*env)->GetStaticMethodID(env, mActivityClass, "getManifestEnvironmentVariables", "(void)Z");
    midGetNativeSurface = (*env)->GetStaticMethodID(env, mActivityClass, "getNativeSurface", "(void)Landroid/view/Surface;");
    midInitTouch = (*env)->GetStaticMethodID(env, mActivityClass, "initTouch", "(void)V");
    midIsAndroidTV = (*env)->GetStaticMethodID(env, mActivityClass, "isAndroidTV", "(void)Z");
    midIsChromebook = (*env)->GetStaticMethodID(env, mActivityClass, "isChromebook", "(void)Z");
    midIsDeXMode = (*env)->GetStaticMethodID(env, mActivityClass, "isDeXMode", "(void)Z");
    midIsScreenKeyboardShown = (*env)->GetStaticMethodID(env, mActivityClass, "isScreenKeyboardShown", "(void)Z");
    midIsTablet = (*env)->GetStaticMethodID(env, mActivityClass, "isTablet", "(void)Z");
    midManualBackButton = (*env)->GetStaticMethodID(env, mActivityClass, "manualBackButton", "(void)V");
    midMinimizeWindow = (*env)->GetStaticMethodID(env, mActivityClass, "minimizeWindow", "(void)V");
    ...
    midShouldMinimizeOnFocusLoss = (*env)->GetStaticMethodID(env, mActivityClass, "shouldMinimizeOnFocusLoss", "(void)Z");
    midShowTextInput = (*env)->GetStaticMethodID(env, mActivityClass, "showTextInput", "(IIII)Z");
    midSupportsRelativeMouse = (*env)->GetStaticMethodID(env, mActivityClass, "supportsRelativeMouse", "(void)Z");
...
/* Audio initialization -- called before SDL_main(void) to initialize JNI bindings */
JNIEXPORT void JNICALL SDL_JAVA_AUDIO_INTERFACE(nativeSetupJNI)(JNIEnv *env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "AUDIO nativeSetupJNI(void)");
...
/* Controller initialization -- called before SDL_main(void) to initialize JNI bindings */
JNIEXPORT void JNICALL SDL_JAVA_CONTROLLER_INTERFACE(nativeSetupJNI)(JNIEnv *env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "CONTROLLER nativeSetupJNI(void)");
...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv *env, jclass cls, jstring library, jstring function, jobject array)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain(void) %d time", run_count);
    if (run_count == 1) {
    ...
    if (library_handle) {
        ...
        if (SDL_main) {
            ...
            argc = 0;
            /* Use the name "app_process" so PHYSFS_platformCalcBaseDir(void) works.
            ...
            __android_log_print(ANDROID_LOG_ERROR, "SDL", "nativeRunMain(void): Couldn't find function %s in library %s", function_name, library_file);
        }
        ...
        __android_log_print(ANDROID_LOG_ERROR, "SDL", "nativeRunMain(void): Couldn't load library %s", library_file);
    }
    ...
    jint rotation)
{
    ...
    if (Android_Window) {
        SDL_VideoDisplay *display = SDL_GetVideoDisplay(SDL_GetPrimaryDisplay(void));
                                         ...
                                         jstring name, jint device_id)
{
    ...
    if (SDL_GetCurrentAudioDriver(void) != NULL) {
...
/* Called from surfaceCreated(void) */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(onNativeSurfaceCreated)(JNIEnv *env, jclass jcls)
{
    ...
    if (Android_Window) {
        ...
        data->native_window = Android_JNI_GetNativeWindow(void);
...
/* Called from surfaceChanged(void) */
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(onNativeSurfaceChanged)(JNIEnv *env, jclass jcls)
{
    ...
    if (Android_Window) {
        SDL_VideoDevice *_this = SDL_GetVideoDevice(void);
        SDL_WindowData *data = Android_Window->driverdata;
...
/* Called from surfaceDestroyed(void) */
...
#ifdef SDL_VIDEO_OPENGL_EGL
        if (data->egl_surface != EGL_NO_SURFACE) {
            SDL_EGL_DestroySurface(SDL_GetVideoDevice(void), data->egl_surface);
    ...
    JNIEnv *env, jclass cls)
{
     ...
     * in SDL_EVENT_WILL_ENTER_BACKGROUND. After nativeSendQuit(void) is called, no
    ...
    JNIEnv *env, jclass cls)
{
    ...
    Internal_Android_Destroy_AssetManager(void);

    str = SDL_GetError(void);
    if (str && str[0]) {
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePause)(
    JNIEnv *env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativePause(void)");
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativeResume)(
    JNIEnv *env, jclass cls)
{
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeResume(void)");
    ...
    JNIEnv *env, jclass cls, jboolean hasFocus)
{
    ...
    if (Android_Window) {
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeFocusChanged(void)");
...
ANativeWindow *Android_JNI_GetNativeWindow(void)
{
    ...
    jobject s;
    JNIEnv *env = Android_JNI_GetEnv(void);
...
/* If the parameter silent is truthy then SDL_SetError(void) will not be called. */
static SDL_bool Android_JNI_ExceptionOccurred(SDL_bool silent)
{
    ...
    if (exception != NULL) {
        ...
        if (!silent) {
            ...
            mid = (*env)->GetMethodID(env, classClass, "getName", "(void)Ljava/lang/String;");
            ...
            mid = (*env)->GetMethodID(env, exceptionClass, "getMessage", "(void)Ljava/lang/String;");
...
static void Internal_Android_Create_AssetManager(void)
{
    ...
    /* context = SDLActivity.getContext(void); */
    context = (*env)->CallStaticObjectMethod(env, mActivityClass, midGetContext);

    /* javaAssetManager = context.getAssets(void); */
    mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, context),
                              "getAssets", "(void)Landroid/content/res/AssetManager;");
                         ...
                         const char *fileName, const char *mode)
{
    ...
    if (!asset_manager) {
        Internal_Android_Create_AssetManager(void);
    }
...
size_t Android_JNI_FileRead(SDL_RWops *ctx, void *buffer, size_t size)
{
    ...
    if (bytes < 0) {
        SDL_SetError("AAsset_read(void) failed");
        return 0;
    }
    return (size_t)bytes;
}
...
{
    return Android_JNI_GetEnv(void);
}
...
void *SDL_AndroidGetActivity(void)
{
    ...
    /* return SDLActivity.getContext(void); */
...
const char *SDL_AndroidGetInternalStoragePath(void)
{
    ...
    if (!s_AndroidInternalFilesPath) {
        ...
        /* fileObj = context.getFilesDir(void); */
        mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, context),
                                  "getFilesDir", "(void)Ljava/io/File;");
        ...
        /* path = fileObject.getCanonicalPath(void); */
        mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, fileObject),
                                  "getCanonicalPath", "(void)Ljava/lang/String;");
...
int SDL_AndroidGetExternalStorageState(Uint32 *state)
{
    ...
    mid = (*env)->GetStaticMethodID(env, cls,
                                    "getExternalStorageState", "(void)Ljava/lang/String;");
...
const char *SDL_AndroidGetExternalStoragePath(void)
{
    ...
    if (!s_AndroidExternalFilesPath) {
        ...
        /* fileObj = context.getExternalFilesDir(void); */
        mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, context),
        ...
        /* path = fileObject.getAbsolutePath(void); */
        mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, fileObject),
                                  "getAbsolutePath", "(void)Ljava/lang/String;");
        pathString = (jstring)(*env)->CallObjectMethod(env, fileObject, mid);
