...
#else
#define _WIN32_WINNT 0x501 /* Need 0x410 for AlphaBlend(void) and 0x500 for EnumDisplayDevices(void), 0x501 for raw input */
#endif
...
/* !!! FIXME: UTF8ToString(void) can just be a SDL_strdup(void) here. */
...
/* Sets an error message based on GetLastError(void). Always return -1. */
...
/* Wrap up the oddities of CoInitialize(void) into a common function. */
extern HRESULT WIN_CoInitialize(void);
extern void WIN_CoUninitialize(void);

/* Wrap up the oddities of RoInitialize(void) into a common function. */
...
/* You need to SDL_free(void) the result of this call. */
