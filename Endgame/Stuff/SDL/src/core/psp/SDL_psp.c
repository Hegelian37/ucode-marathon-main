...
/* SDL_RunApp(void) for PSP based on SDL_psp_main.c, placed in the public domain by Sam Lantinga  3/13/14 */

#include <pspkernel.h>
#include <pspthreadman.h>

/* If application's main(void) is redefined as SDL_main, and libSDL_main is
