...
void SDL_UIKit_UpdateBatteryMonitoring(void)
{
    if (SDL_UIKitLastPowerInfoQuery) {
        if (SDL_GetTicks(void) >= (SDL_UIKitLastPowerInfoQuery + BATTERY_MONITORING_TIMEOUT)) {
...
SDL_bool SDL_GetPowerInfo_UIKit(SDL_PowerState *state, int *seconds, int *percent)
{
    ...
    *percent = -1;
    ...
    @autoreleasepool {
        ...
        /* UIKit_GL_SwapWindow(void) (etc) will check this and disable the battery
         ...
         */
        SDL_UIKitLastPowerInfoQuery = SDL_GetTicks(void);
