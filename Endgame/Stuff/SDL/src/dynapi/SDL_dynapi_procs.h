...
SDL_DYNAPI_PROC(void,SDL_UnregisterApp,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_GDKSuspendComplete,(void),(void),)

SDL_DYNAPI_PROC(SDL_WinRT_DeviceFamily,SDL_WinRTGetDeviceFamily,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_OnApplicationDidChangeStatusBarOrientation,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_AndroidBackButton,(void),(void),)
SDL_DYNAPI_PROC(void*,SDL_AndroidGetActivity,(void),(void),return)
SDL_DYNAPI_PROC(const char*,SDL_AndroidGetExternalStoragePath,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_AndroidGetExternalStorageState,(Uint32 *a),(a),return)
SDL_DYNAPI_PROC(const char*,SDL_AndroidGetInternalStoragePath,(void),(void),return)
SDL_DYNAPI_PROC(void*,SDL_AndroidGetJNIEnv,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_GetAndroidSDKVersion,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_IsAndroidTV,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_IsChromebook,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_IsDeXMode,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_CleanupTLS,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_ClearComposition,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_ClearError,(void),(void),)
...
SDL_DYNAPI_PROC(SDL_Condition*,SDL_CreateCondition,(void),(void),return)
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_CreateCursor,(const Uint8 *a, const Uint8 *b, int c, int d, int e, int f),(a,b,c,d,e,f),return)
SDL_DYNAPI_PROC(SDL_Mutex*,SDL_CreateMutex,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_RWops*,SDL_CreateRW,(void),(void),return)
SDL_DYNAPI_PROC(SDL_RWLock*,SDL_CreateRWLock,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_TLSID,SDL_CreateTLS,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_CursorVisible,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_DisableScreenSaver,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_EGLDisplay,SDL_EGL_GetCurrentEGLDisplay,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_EnableScreenSaver,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_GLContext,SDL_GL_GetCurrentContext,(void),(void),return)
SDL_DYNAPI_PROC(SDL_Window*,SDL_GL_GetCurrentWindow,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_GL_ResetAttributes,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_GL_UnloadLibrary,(void),(void),)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_GamepadEventsEnabled,(void),(void),return)
...
SDL_DYNAPI_PROC(const SDL_AssertData*,SDL_GetAssertionReport,(void),(void),return)
SDL_DYNAPI_PROC(char*,SDL_GetBasePath,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_GetCPUCacheLineSize,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_GetCPUCount,(void),(void),return)
SDL_DYNAPI_PROC(void*,SDL_GetClipboardData,(const char *a, size_t *b),(a,b),return)
SDL_DYNAPI_PROC(char*,SDL_GetClipboardText,(void),(void),return)
...
SDL_DYNAPI_PROC(const char*,SDL_GetCurrentVideoDriver,(void),(void),return)
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_GetCursor,(void),(void),return)
SDL_DYNAPI_PROC(SDL_AssertionHandler,SDL_GetDefaultAssertionHandler,(void),(void),return)
SDL_DYNAPI_PROC(SDL_Cursor*,SDL_GetDefaultCursor,(void),(void),return)
...
SDL_DYNAPI_PROC(const char*,SDL_GetError,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_Window*,SDL_GetGrabbedWindow,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_Window*,SDL_GetKeyboardFocus,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_Keymod,SDL_GetModState,(void),(void),return)
SDL_DYNAPI_PROC(SDL_Window*,SDL_GetMouseFocus,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_GetNumAllocations,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_GetNumRenderDrivers,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_GetNumTouchFingers,(SDL_TouchID a),(a),return)
SDL_DYNAPI_PROC(int,SDL_GetNumVideoDrivers,(void),(void),return)
SDL_DYNAPI_PROC(void,SDL_GetOriginalMemoryFunctions,(SDL_malloc_func *a, SDL_calloc_func *b, SDL_realloc_func *c, SDL_free_func *d),(a,b,c,d),)
SDL_DYNAPI_PROC(char*,SDL_GetUserFolder,(SDL_Folder a),(a),return)
SDL_DYNAPI_PROC(Uint64,SDL_GetPerformanceCounter,(void),(void),return)
SDL_DYNAPI_PROC(Uint64,SDL_GetPerformanceFrequency,(void),(void),return)
...
SDL_DYNAPI_PROC(const char*,SDL_GetPlatform,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_Locale*,SDL_GetPreferredLocales,(void),(void),return)
SDL_DYNAPI_PROC(SDL_DisplayID,SDL_GetPrimaryDisplay,(void),(void),return)
SDL_DYNAPI_PROC(char*,SDL_GetPrimarySelectionText,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_GetRelativeMouseMode,(void),(void),return)
...
SDL_DYNAPI_PROC(const char*,SDL_GetRevision,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_GetSystemRAM,(void),(void),return)
SDL_DYNAPI_PROC(SDL_SystemTheme,SDL_GetSystemTheme,(void),(void),return)
...
SDL_DYNAPI_PROC(Uint64,SDL_GetTicks,(void),(void),return)
SDL_DYNAPI_PROC(Uint64,SDL_GetTicksNS,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_Haptic*,SDL_OpenHapticFromMouse,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_HasARMSIMD,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasAVX,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasAVX2,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasAVX512F,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasAltiVec,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasClipboardData,(const char *a),(a),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasClipboardText,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_HasLASX,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasLSX,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasMMX,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasNEON,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasPrimarySelectionText,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_HasSSE,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasSSE2,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasSSE3,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasSSE41,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasSSE42,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasScreenKeyboardSupport,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_WindowHasSurface,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_HideCursor,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_IsTablet,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_JoystickConnected,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_JoystickEventsEnabled,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_LockJoysticks,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_LogResetPriorities,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_MemoryBarrierAcquireFunction,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_MemoryBarrierReleaseFunction,(void),(void),)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_IsMouseHaptic,(void),(void),return)
SDL_DYNAPI_PROC(void,SDL_OnApplicationDidBecomeActive,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_OnApplicationDidEnterBackground,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_OnApplicationDidReceiveMemoryWarning,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_OnApplicationWillEnterForeground,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_OnApplicationWillResignActive,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_OnApplicationWillTerminate,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_PumpEvents,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_Quit,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_ResetAssertionReport,(void),(void),)
SDL_DYNAPI_PROC(SDL_bool,SDL_ResetHint,(const char *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_ResetHints,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_ResetKeyboard,(void),(void),)
...
SDL_DYNAPI_PROC(size_t,SDL_SIMDGetAlignment,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_ScreenSaverEnabled,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_SetMainReady,(void),(void),)
...
SDL_DYNAPI_PROC(int,SDL_ShowCursor,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_StartTextInput,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_StopTextInput,(void),(void),)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_TextInputActive,(void),(void),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_TextInputShown,(void),(void),return)
SDL_DYNAPI_PROC(SDL_ThreadID,SDL_GetCurrentThreadID,(void),(void),return)
...
SDL_DYNAPI_PROC(void,SDL_UnlockJoysticks,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_UpdateGamepads,(void),(void),)
SDL_DYNAPI_PROC(void,SDL_UpdateJoysticks,(void),(void),)
...
SDL_DYNAPI_PROC(void,SDL_UpdateSensors,(void),(void),)
...
SDL_DYNAPI_PROC(SDL_FunctionPointer,SDL_Vulkan_GetVkGetInstanceProcAddr,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_Vulkan_LoadLibrary,(const char *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_Vulkan_UnloadLibrary,(void),(void),)
...
SDL_DYNAPI_PROC(Uint32,SDL_hid_device_change_count,(void),(void),return)
SDL_DYNAPI_PROC(SDL_hid_device_info*,SDL_hid_enumerate,(unsigned short a, unsigned short b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_hid_exit,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_hid_init,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_ClearClipboardData,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_ReloadGamepadMappings,(void),(void),return)
SDL_DYNAPI_PROC(int,SDL_GetNumAudioDrivers,(void),(void),return)
SDL_DYNAPI_PROC(const char*,SDL_GetAudioDriver,(int a),(a),return)
SDL_DYNAPI_PROC(const char*,SDL_GetCurrentAudioDriver,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_PropertiesID,SDL_CreateProperties,(void),(void),return)
...
SDL_DYNAPI_PROC(SDL_PropertiesID,SDL_GetGlobalProperties,(void),(void),return)
...
SDL_DYNAPI_PROC(int,SDL_GetNumCameraDrivers,(void),(void),return)
SDL_DYNAPI_PROC(const char*,SDL_GetCameraDriver,(int a),(a),return)
SDL_DYNAPI_PROC(const char*,SDL_GetCurrentCameraDriver,(void),(void),return)
