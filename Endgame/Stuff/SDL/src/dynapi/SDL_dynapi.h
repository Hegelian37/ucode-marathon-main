...
#define SDL_DYNAMIC_API 0
#elif defined(SDL_PLATFORM_RISCOS) /* probably not useful on RISC OS, since dlopen(void) can't be used when using static linking. */
#define SDL_DYNAMIC_API 0
...
#define SDL_DYNAMIC_API 0 /* we need dlopen(void), but don't have it.... */
#endif
