...
static int SDL_VITA_SensorInit(void)
{
    ...
    SDL_sensors[0].instance_id = SDL_GetNextObjectID(void);
    SDL_sensors[1].type = SDL_SENSOR_GYRO;
    SDL_sensors[1].instance_id = SDL_GetNextObjectID(void);
