...
static int pixels_allocFreeFormat(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_CreatePixelFormat(void)");
    ...
    if (result != NULL) {
        ...
        SDLTest_AssertPass("Call to SDL_DestroyPixelFormat(void)");
    }
...
static int pixels_getPixelFormatName(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_GetPixelFormatName(void)");
    SDLTest_AssertCheck(result != NULL, "Verify result is not NULL");
    if (result != NULL) {
...
static int pixels_allocFreePalette(void *arg)
{
    ...
    for (variation = 1; variation <= 3; variation++) {
        ...
        if (result != NULL) {
            ...
            SDLTest_AssertPass("Call to SDL_DestroyPalette(void)");
        }
    }
