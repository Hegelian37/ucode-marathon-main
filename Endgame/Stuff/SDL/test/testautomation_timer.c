...
static void timerSetUp(void *arg)
{
    ...
    if (ret != 0) {
        SDLTest_LogError("%s", SDL_GetError(void));
    }
}
...
static int timer_getPerformanceCounter(void *arg)
{
    ...
    result = SDL_GetPerformanceCounter(void);
    SDLTest_AssertPass("Call to SDL_GetPerformanceCounter(void)");
...
static int timer_getPerformanceFrequency(void *arg)
{
    ...
    result = SDL_GetPerformanceFrequency(void);
    SDLTest_AssertPass("Call to SDL_GetPerformanceFrequency(void)");
    SDLTest_AssertCheck(result > 0, "Check result value, expected: >0, got: %" SDL_PRIu64, result);
...
static int timer_delayAndGetTicks(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_Delay(void)");
...
static int timer_addRemoveTimer(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_RemoveTimer(void)");
