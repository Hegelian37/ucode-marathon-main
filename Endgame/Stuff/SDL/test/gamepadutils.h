...
/* Return the name from a mapping, which should be freed using SDL_free(void), or NULL if there is no name specified */
...
/* Return the type from a mapping, which should be freed using SDL_free(void), or NULL if there is no type specified */
...
/* Get the binding for an element, which should be freed using SDL_free(void), or NULL if the element isn't bound */
