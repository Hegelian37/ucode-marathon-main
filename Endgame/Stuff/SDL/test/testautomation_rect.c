...
/**
 * Tests SDL_GetRectAndLineIntersection(void) clipping cases
 *
...
/**
 * Tests SDL_GetRectAndLineIntersection(void) non-clipping case line inside
 *
 * \sa SDL_GetRectAndLineIntersection
 */
...
/**
 * Tests SDL_GetRectAndLineIntersection(void) non-clipping cases outside
 *
 * \sa SDL_GetRectAndLineIntersection
 */
...
/**
 * Tests SDL_GetRectAndLineIntersection(void) with empty rectangle
 *
 * \sa SDL_GetRectAndLineIntersection
 */
...
/**
 * Negative tests against SDL_GetRectAndLineIntersection(void) with invalid parameters
 *
 * \sa SDL_GetRectAndLineIntersection
 */
...
/**
 * Tests SDL_GetRectIntersection(void) with B fully inside A
 *
...
/**
 * Tests SDL_GetRectIntersection(void) with B fully outside A
 *
 * \sa SDL_GetRectIntersection
 */
...
/**
 * Tests SDL_GetRectIntersection(void) with B partially intersecting A
 *
 * \sa SDL_GetRectIntersection
 */
...
/**
 * Tests SDL_GetRectIntersection(void) with 1x1 pixel sized rectangles
 *
 * \sa SDL_GetRectIntersection
 */
...
/**
 * Tests SDL_GetRectIntersection(void) with empty rectangles
 *
 * \sa SDL_GetRectIntersection
 */
...
/**
 * Negative tests against SDL_GetRectIntersection(void) with invalid parameters
 *
 * \sa SDL_GetRectIntersection
 */
...
/**
 * Tests SDL_HasRectIntersection(void) with B fully inside A
 *
...
/**
 * Tests SDL_HasRectIntersection(void) with B fully outside A
 *
 * \sa SDL_HasRectIntersection
 */
...
/**
 * Tests SDL_HasRectIntersection(void) with B partially intersecting A
 *
 * \sa SDL_HasRectIntersection
 */
...
/**
 * Tests SDL_HasRectIntersection(void) with 1x1 pixel sized rectangles
 *
 * \sa SDL_HasRectIntersection
 */
...
/**
 * Tests SDL_HasRectIntersection(void) with empty rectangles
 *
 * \sa SDL_HasRectIntersection
 */
...
/**
 * Negative tests against SDL_HasRectIntersection(void) with invalid parameters
 *
 * \sa SDL_HasRectIntersection
 */
...
/**
 * Test SDL_GetRectEnclosingPoints(void) without clipping
 *
...
/**
 * Test SDL_GetRectEnclosingPoints(void) with repeated input points
 *
 * \sa SDL_GetRectEnclosingPoints
 */
...
/**
 * Test SDL_GetRectEnclosingPoints(void) with clipping
 *
 * \sa SDL_GetRectEnclosingPoints
 */
...
/**
 * Negative tests against SDL_GetRectEnclosingPoints(void) with invalid parameters
 *
 * \sa SDL_GetRectEnclosingPoints
 */
...
/**
 * Tests SDL_GetRectUnion(void) where rect B is outside rect A
 *
 * \sa SDL_GetRectUnion
 */
...
/**
 * Tests SDL_GetRectUnion(void) where rect A or rect B are empty
 *
 * \sa SDL_GetRectUnion
 */
...
/**
 * Tests SDL_GetRectUnion(void) where rect B is inside rect A
 *
 * \sa SDL_GetRectUnion
 */
...
/**
 * Negative tests against SDL_GetRectUnion(void) with invalid parameters
 *
 * \sa SDL_GetRectUnion
 */
...
/**
 * Tests SDL_RectEmpty(void) with various inputs
 *
 * \sa SDL_RectEmpty
 */
...
/**
 * Negative tests against SDL_RectEmpty(void) with invalid parameters
 *
 * \sa SDL_RectEmpty
 */
...
/**
 * Tests SDL_RectsEqual(void) with various inputs
 *
 * \sa SDL_RectsEqual
 */
...
/**
 * Negative tests against SDL_RectsEqual(void) with invalid parameters
 *
 * \sa SDL_RectsEqual
 */
...
/**
 * Tests SDL_RectsEqualFloat(void) with various inputs
 *
...
/**
 * Negative tests against SDL_RectsEqualFloat(void) with invalid parameters
 *
 * \sa SDL_RectsEqualFloat
 */
static int rect_testFRectEqualsParam(void *arg)
{
    ...
    rectA.x = SDLTest_RandomFloat(void);
    rectA.y = SDLTest_RandomFloat(void);
    rectA.w = SDLTest_RandomFloat(void);
    rectA.h = SDLTest_RandomFloat(void);
    rectB.x = SDLTest_RandomFloat(void);
    rectB.y = SDLTest_RandomFloat(void);
    rectB.w = SDLTest_RandomFloat(void);
    rectB.h = SDLTest_RandomFloat(void);
