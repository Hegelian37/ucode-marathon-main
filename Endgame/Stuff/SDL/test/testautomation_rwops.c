...
static int rwops_testMem(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_RWFromMem(void) succeeded");
    ...
    SDLTest_AssertPass("Call to SDL_RWclose(void) succeeded");
...
static int rwops_testConstMem(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_RWFromConstMem(void) succeeded");
...
{
    /* Allocate context */
    SDL_RWops *rw = SDL_CreateRW(void);
    SDLTest_AssertPass("Call to SDL_CreateRW(void) succeeded");
    SDLTest_AssertCheck(rw != NULL, "Validate result from SDL_CreateRW(void) is not NULL");
    if (rw == NULL) {
        return TEST_ABORTED;
    }
    ...
    /* Free context again */
    SDL_DestroyRW(rw);
    SDLTest_AssertPass("Call to SDL_DestroyRW(void) succeeded");
...
static int rwops_testCompareRWFromMemWithRWFromFile(void *arg)
{
    ...
    for (size = 5; size < 10; size++) {
        ...
        SDLTest_AssertPass("Call to SDL_RWFromMem(void)");
        ...
        SDLTest_AssertPass("Call to SDL_RWFromFile(void)");
...
static int rwops_testFileWriteReadEndian(void *arg)
{
    ...
    for (mode = 0; mode < 3; mode++) {
        ...
        case 2:
            ...
            BE16value = SDLTest_RandomUint16(void);
            BE32value = SDLTest_RandomUint32(void);
            BE64value = SDLTest_RandomUint64(void);
            LE16value = SDLTest_RandomUint16(void);
            LE32value = SDLTest_RandomUint32(void);
            LE64value = SDLTest_RandomUint64(void);
            break;
        }
        ...
        SDLTest_AssertPass("Call to SDL_WriteU16BE(void)");
        ...
        SDLTest_AssertPass("Call to SDL_WriteU32BE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object written, expected: SDL_TRUE, got: SDL_FALSE");
        bresult = SDL_WriteU64BE(rw, BE64value);
        SDLTest_AssertPass("Call to SDL_WriteU64BE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object written, expected: SDL_TRUE, got: SDL_FALSE");
        bresult = SDL_WriteU16LE(rw, LE16value);
        SDLTest_AssertPass("Call to SDL_WriteU16LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object written, expected: SDL_TRUE, got: SDL_FALSE");
        bresult = SDL_WriteU32LE(rw, LE32value);
        SDLTest_AssertPass("Call to SDL_WriteU32LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object written, expected: SDL_TRUE, got: SDL_FALSE");
        bresult = SDL_WriteU64LE(rw, LE64value);
        SDLTest_AssertPass("Call to SDL_WriteU64LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object written, expected: SDL_TRUE, got: SDL_FALSE");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU16BE(void)");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU32BE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object read, expected: SDL_TRUE, got: SDL_FALSE");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU64BE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object read, expected: SDL_TRUE, got: SDL_FALSE");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU16LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object read, expected: SDL_TRUE, got: SDL_FALSE");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU32LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object read, expected: SDL_TRUE, got: SDL_FALSE");
        ...
        SDLTest_AssertPass("Call to SDL_ReadU64LE(void)");
        SDLTest_AssertCheck(bresult == SDL_TRUE, "Validate object read, expected: SDL_TRUE, got: SDL_FALSE");
