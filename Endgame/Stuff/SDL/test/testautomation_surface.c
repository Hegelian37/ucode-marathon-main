...
/* Suppress C4996 VS compiler warnings for unlink(void) */
...
{                                   \
    ...
    if (result != 0) {              \
        SDLTest_AssertCheck(result == 0, "Validate result from %s, expected: 0, got: %i, %s", #FUNC, result, SDL_GetError(void)); \
    }                               \
}
...
static void surfaceSetUp(void *arg)
{
    ...
    referenceSurface = SDLTest_ImageBlit(void); /* For size info */
...
static void clearTestSurface(void)
{
    ...
    SDLTest_AssertPass("Call to SDL_MapRGBA(void)");
    ret = SDL_FillSurfaceRect(testSurface, NULL, color);
    SDLTest_AssertPass("Call to SDL_FillSurfaceRect(void)");
...
static void testBlitBlendMode(int mode)
{
    ...
    SDLTest_AssertPass("Call to SDL_SetSurfaceAlphaMod(void)");
    SDLTest_AssertCheck(ret == 0, "Verify result from SDL_SetSurfaceAlphaMod(void), expected: 0, got: %i", ret);

    /* Reset color modulation */
    ret = SDL_SetSurfaceColorMod(face, 255, 255, 255);
    SDLTest_AssertPass("Call to SDL_SetSurfaceColorMod(void)");
    SDLTest_AssertCheck(ret == 0, "Verify result from SDL_SetSurfaceColorMod(void), expected: 0, got: %i", ret);

    /* Reset color key */
    ret = SDL_SetSurfaceColorKey(face, SDL_FALSE, 0);
    SDLTest_AssertPass("Call to SDL_SetSurfaceColorKey(void)");
    SDLTest_AssertCheck(ret == 0, "Verify result from SDL_SetSurfaceColorKey(void), expected: 0, got: %i", ret);

    /* Clear the test surface */
    clearTestSurface(void);
    ...
    if (mode >= 0) {
        ...
        SDLTest_AssertPass("Call to SDL_SetSurfaceBlendMode(void)");
...
static int surface_testSaveLoadBitmap(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_SaveBMP(void)");
    ...
    SDLTest_AssertPass("Call to SDL_LoadBMP(void)");
...
static int surface_testSurfaceConversion(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_ConvertSurface(void)");
...
static int surface_testBlit(void *arg)
{
    ...
    compareSurface = SDLTest_ImageBlit(void);
...
static int surface_testBlitColorMod(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitColor(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitAlphaMod(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitAlpha(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitBlendNone(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitBlendNone(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitBlendBlend(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitBlend(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitBlendAdd(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitBlendAdd(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitBlendMod(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitBlendMod(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testBlitBlendLoop(void *arg)
{
    ...
    /* Verify result by comparing surfaces */
    compareSurface = SDLTest_ImageBlitBlendAll(void);
    ret = SDLTest_CompareSurfaces(testSurface, compareSurface, 0);
    SDLTest_AssertCheck(ret == 0, "Validate result from SDLTest_CompareSurfaces, expected: 0, got: %i", ret);
...
static int surface_testOverflow(void *arg)
{
    ...
    SDLTest_AssertCheck(SDL_strcmp(SDL_GetError(void), expectedError) == 0,
                        "Expected \"%s\", got \"%s\"", expectedError, SDL_GetError(void));
    ...
    SDLTest_AssertCheck(surface != NULL, "Allow zero pitch for partially set up surfaces: %s",
                        surface != NULL ? "(success)" : SDL_GetError(void));
...
static int surface_testFlip(void *arg)
{
    ...
    SDLTest_AssertCheck(surface != NULL, "SDL_CreateSurface(void)");
