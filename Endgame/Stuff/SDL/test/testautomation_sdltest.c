...
/**
 * Calls to SDLTest_GenerateRunSeed(void)
 */
static int sdltest_generateRunSeed(void *arg)
{
    ...
    for (i = 1; i <= 10; i += 3) {
        ...
        SDLTest_AssertPass("Call to SDLTest_GenerateRunSeed(void)");
...
/**
 * Calls to SDLTest_GetFuzzerInvocationCount(void)
 */
static int sdltest_getFuzzerInvocationCount(void *arg)
{
    ...
    fuzzerCount1 = SDLTest_GetFuzzerInvocationCount(void);
    SDLTest_AssertPass("Call to SDLTest_GetFuzzerInvocationCount(void)");
    SDLTest_AssertCheck(fuzzerCount1 >= 0, "Verify returned value, expected: >=0, got: %d", fuzzerCount1);

    result = SDLTest_RandomUint8(void);
    SDLTest_AssertPass("Call to SDLTest_RandomUint8(void), returned %d", result);

    fuzzerCount2 = SDLTest_GetFuzzerInvocationCount(void);
    SDLTest_AssertPass("Call to SDLTest_GetFuzzerInvocationCount(void)");
...
static int sdltest_randomNumber(void *arg)
{
    ...
    result = (Sint64)SDLTest_RandomUint8(void);
    umax = (1 << 8) - 1;
    ...
    result = (Sint64)SDLTest_RandomSint8(void);
    min = 0 - (1 << 7);
    max = (1 << 7) - 1;
    ...
    result = (Sint64)SDLTest_RandomUint16(void);
    umax = (1 << 16) - 1;
    SDLTest_AssertPass("Call to SDLTest_RandomUint16");
    SDLTest_AssertCheck(result >= 0 && result <= (Sint64)umax, "Verify result value, expected: [0,%" SDL_PRIu64 "], got: %" SDL_PRIs64, umax, result);

    result = (Sint64)SDLTest_RandomSint16(void);
    min = 0 - (1 << 15);
    max = (1 << 15) - 1;
    SDLTest_AssertPass("Call to SDLTest_RandomSint16");
    SDLTest_AssertCheck(result >= min && result <= max, "Verify result value, expected: [%" SDL_PRIs64 ",%" SDL_PRIs64 "], got: %" SDL_PRIs64, min, max, result);

    result = (Sint64)SDLTest_RandomUint32(void);
    umax = ((Uint64)1 << 32) - 1;
    SDLTest_AssertPass("Call to SDLTest_RandomUint32");
    SDLTest_AssertCheck(result >= 0 && result <= (Sint64)umax, "Verify result value, expected: [0,%" SDL_PRIu64 "], got: %" SDL_PRIs64, umax, result);

    result = (Sint64)SDLTest_RandomSint32(void);
    min = 0 - ((Sint64)1 << 31);
    max = ((Sint64)1 << 31) - 1;
    ...
    result = SDLTest_RandomSint64(void);
    SDLTest_AssertPass("Call to SDLTest_RandomSint64");

    dresult = (double)SDLTest_RandomUnitFloat(void);
    ...
    dresult = (double)SDLTest_RandomFloat(void);
    ...
    dresult = SDLTest_RandomUnitDouble(void);
    SDLTest_AssertPass("Call to SDLTest_RandomUnitDouble");
    SDLTest_AssertCheck(dresult >= 0.0 && dresult < 1.0, "Verify result value, expected: [0.0,1.0[, got: %e", dresult);

    dresult = SDLTest_RandomDouble(void);
...
static int sdltest_randomIntegerInRange(void *arg)
{
    ...
    /* Standard range */
    min = (Sint32)SDLTest_RandomSint16(void);
    max = min + (Sint32)SDLTest_RandomUint8(void) + 2;
...
static int sdltest_randomAsciiString(void *arg)
{
    ...
    result = SDLTest_RandomAsciiString(void);
    SDLTest_AssertPass("Call to SDLTest_RandomAsciiString(void)");
...
static int sdltest_randomAsciiStringWithMaximumLength(void *arg)
{
    ...
    targetLen = 16 + SDLTest_RandomUint8(void);
