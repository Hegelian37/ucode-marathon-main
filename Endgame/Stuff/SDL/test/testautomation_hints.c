...
static int hints_setHint(void *arg)
{
    ...
    SDLTest_AssertPass("Call to SDL_GetHint(void) after saving and restoring hint");
    ...
    SDLTest_AssertPass("Call to SDL_ResetHint(void)");
    ...
    SDLTest_AssertPass("Call to SDL_AddHintCallback(void)");
    callbackValue = NULL;
    ...
    SDLTest_AssertPass("Call to SDL_ResetHint(void), using callback");
    callbackValue = NULL;
    SDL_ResetHint(testHint);
    SDLTest_AssertCheck(
        callbackValue && SDL_strcmp(callbackValue, "original") == 0,
    ...
    SDLTest_AssertPass("Call to SDL_ResetHint(void), after clearing callback");
    callbackValue = NULL;
