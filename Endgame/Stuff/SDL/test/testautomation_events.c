...
static int events_pushPumpAndPollUserevent(void *arg)
{
    ...
    event1.user.code = SDLTest_RandomSint32(void);
    ...
    SDLTest_AssertPass("Call to SDL_PushEvent(void)");
    SDL_PumpEvents(void);
    SDLTest_AssertPass("Call to SDL_PumpEvents(void)");

    /* Poll for user event */
    result = SDL_PollEvent(&event2);
    SDLTest_AssertPass("Call to SDL_PollEvent(void)");
...
static int events_addDelEventWatch(void *arg)
{
    ...
    event.user.code = SDLTest_RandomSint32(void);
    ...
    SDLTest_AssertPass("Call to SDL_AddEventWatch(void)");
    ...
    SDLTest_AssertPass("Call to SDL_DelEventWatch(void)");
